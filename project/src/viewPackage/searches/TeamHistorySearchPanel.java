...
public class TeamHistorySearchPanel extends JPanel implements Panel {
    ...
    public void enterPanel() {
        ...
        JComboBox<Team> teamComboBox = new JComboBox<>(teams.toArray(new Team[0]));
        ...
        searchButton.addActionListener(e -> {
            ...
            if (selectedTeam != null && beginningDate.isBefore(endingDate)) {
                try {
                    ...
                    String[] columnNames = {
                            "Beginning Date", "Ending Date", "Team Name", "Club Name", "Nationality",
                            "Player 1 Names", "Player 2 Names", "Player 3 Names", "Player 4 Names", "Player 5 Names"
                    };
                    ...
                    for (int i = 0; i < results.size(); i++) {
                        ...
                        data[i][5] = results.get(i).getPlayer1FirstName() + " " + results.get(i).getPlayer1LastName();
                        data[i][6] = results.get(i).getPlayer2FirstName() + " " + results.get(i).getPlayer2LastName();
                        data[i][7] = results.get(i).getPlayer3FirstName() + " " + results.get(i).getPlayer3LastName();
                        data[i][8] = results.get(i).getPlayer4FirstName() + " " + results.get(i).getPlayer4LastName();
                        data[i][9] = results.get(i).getPlayer5FirstName() + " " + results.get(i).getPlayer5LastName();
                    }
